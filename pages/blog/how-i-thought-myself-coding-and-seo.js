        ...
        <div className="innerWrapper">
          <div className={styles.richText}>
            <p>
              ...
              practice, and patience. Self-taught individuals can become
              valuable assets to employers or clients, save money compared to
              formal education, and enjoy the freedom to work from any location.
            </p>
          </div>
        </div>
        <Footer />
